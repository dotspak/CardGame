...
Force represents both a card’s health and combat damage. Cards perish if they take damage and their force is 0 or less. Cards that have force are considered units.

### Cards with No Force

A card with no force is represented by a greyed out force symbol. These cards perish when they receive any instance of damage, don't deal damage in combat, and cannot gain FORCE.
...
- Skill Box
  - Activated abilities. Normal skills (pink) make the card inactive. Free skills (green) do not. Put in a pink or green box.
...
Skills are an activated ability. A card can have up to 1 skill unless an effect card is attached that gives them a new skill. A card must be active in order for a skill to be activated, unless some other condition says otherwise. You can only activate skills during your turn.

### Normal Skills

Normal skills are represented by a pink text box at the bottom of the card. When you activate a normal skill, the card becomes inactive.

### Free Skills

Free skils are represented by a green text box at the bottom of the card. When you activate a free skill, the card remains active.

### Cast

Casting is similar to using a skill. A card with a blue textbox is able to be cast. A card must be active for it to be cast, unless some other condition says otherwise. When you cast a card, it is sacrificed and then its effect triggers. You are able to cast a card during your opponent's turn at response speed.
...
1. Cards you control become active.
2. Begin triggers activate. You may order them however you wish if you have multiple.
3. Draw a card from the top of your deck.
4. You level cap for that turn is reset.
5. Action Phase — You may:
   - Set cards
   - Declare attacks
   - Cast spells
   - Activate skills
